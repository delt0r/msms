...
public class FixedBitSet {
	...
	/**
	 * counts the number of set bits after an and operation with mask. however this bit set remains unmodified.
	 * @param mask
	 * @return
	 */
	...
	/**
	 * use the fact that if we have n ones in the bit set. Then there are n*(total-n) pair wise 
	 * differences. We then nomalized by nCr? 
	 * @return
	 */
