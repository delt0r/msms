 ...
 * <p>
 * Valid parameter ranges: <tt>mean &gt; 0</tt>. Note: if <tt>mean &lt;= 0.0</tt> then always
 * returns zero.
 * <p>
 * Instance methods operate on a user supplied uniform random number generator; they are
 * unsynchronized.
 * <dt>
 * Static methods operate on a default uniform random number generator; they are synchronized.
 * <p>
 * <b>Implementation:</b> High performance implementation. Patchwork Rejection/Inversion method.
...
public class Poisson {
	...
	protected static final double MEAN_MAX =Integer.MAX_VALUE; // for all means larger than that, we
																// don't try to compute a poisson
...
//	}
	...
	public int nextInt(double theMean) {
		 ...
		 ****************************************************************** 
		 * * For parameter my < 10 Tabulated Inversion is applied. * For my >= 10 Patchwork
		 * Rejection is employed: * The area below the histogram function f(x) is rearranged in *
		 * its body by certain point reflections. Within a large center * interval variates are
		 * sampled efficiently by rejection from * uniform hats. Rectangular immediate acceptance
...
//	}
	...
	public static void main(String[] args){
		Poisson p=new Poisson(new Random64());
		for(int i=0;i<1000;i++){
			System.out.println(p.nextInt(i*.5));
		}
	}
}
